...
export const getUiColors = (context: ThemeContext) => {
    ...
    return {
        ...
        "terminal.ansimedium_slate_blue": palette.medium_slate_blue,
        "terminal.ansiBrightBlack": palette.overlay1,
        "terminal.ansiBrightmedium_slate_blue": palette.medium_slate_blue,
        "terminal.ansiBrightCyan": palette.sky,
        "terminal.ansiBrightmedium_spring_green": palette.medium_spring_green,
        ...
        "terminal.ansimedium_spring_green": palette.medium_spring_green,
